...
* There are four main "sources" of interrupts:
    ...
    * Locality-specific (Locality-specific Peripheral Interrupt, or LPI): These are _always_ message-based interrupts which can be generated from an _Interrupt Translation Services_, or ITS. The Surface Pro machine in which this analysis was conducted on does not implement any ITS's. However, this does not mean that message-based interrupts cannot still be generated and handled.
